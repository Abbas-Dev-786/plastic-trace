...
import { Wallet, Send, Download, TrendingUp, Award, Gift, Eye, History } from "lucide-react";
...
const milestones = [
  { title: "Weekly Collector", progress: 75, target: "50 scans", reward: "100 PTC" },
  { title: "Monthly Champion", progress: 25, target: "200 scans", reward: "500 PTC" },
  { title: "Eco Master", progress: 10, target: "1000 scans", reward: "2000 PTC + NFT" },
];
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Manage your tokens, NFTs, and rewards</p>
        </div>
      ...
      <Card className="bg-gradient-primary text-primary-foreground">
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-white">PlasticTrace Tokens (PTC)</CardTitle>
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              <div className="text-4xl font-bold text-white">{tokenBalance.ptc.toLocaleString()} PTC</div>
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track your progress towards earning bonus rewards</CardDescription>
            </CardHeader>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Target: {milestone.target} • Reward: <span className="text-secondary font-medium">{milestone.reward}</span>
                      </p>
                    </div>
        ...
        <TabsContent value="nfts" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Collectible badges representing your environmental achievements</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {nftCollection.map((nft) => (
                  <Card key={nft.id} className="hover:shadow-elegant transition-shadow">
                    ...
                    <CardContent className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground">Earned: {nft.earned}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
        ...
        <TabsContent value="transactions" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>All your token transactions and rewards</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {transactions.map((tx) => (
                  <div key={tx.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="text-right">
                      <p className={`font-medium ${
                        tx.type === "earn" ? "text-success" : "text-foreground"
                      }`}>
                        {tx.amount}
                      </p>
        ...
        <TabsContent value="rewards" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Redeem your tokens for various rewards and benefits</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <Card className="border-2">
                  <CardHeader>
                    ...
                    <CardDescription>Convert tokens to fiat currency</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                ...
                <Card className="border-2">
                  <CardHeader>
                    ...
                    <CardDescription>Purchase sustainable products with tokens</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="text-sm text-muted-foreground">Starting from 50 PTC</div>
