...
- **Blockchain:** Flow EVM-compatible Layer 2 — core smart contracts and trusted event logging.
- **Smart Contracts:**
...
```mermaid
graph TD
    A[Client<br><i>React + thirdweb</i>] -->|Calls| B[Smart Contracts<br><i>Flow</i>]
    A -->|Fetches| C[Server<br><i>Node.js + MongoDB</i>]
    B -->|Stores| D[Flow Blockchain]
    C -->|Syncs| D
    subgraph Contracts
        B1[RoleManager]
        B2[QRCodeManager]
